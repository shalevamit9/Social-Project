...
router.post('/loginManager/login',
    validation.verifyUser,
    authorization.signJWTandSendToken);

router.post('/loginManager/passwordExceeded',
    validation.verifyUser,
    usersController.getDaysSinceLastPasswordChange);
...
router.get('/userBirthdays',
    authorization.formatAndSetToken,
    authorization.verifyToken,
    usersController.matchBirthday);
